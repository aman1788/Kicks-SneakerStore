...
const WomensKicks = () => {
    ...
    const sizes = [3.5, 4, 4.5, 5, 5.5, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10, 10.5, 11]
        ...
        <div className='shoes-grid'>
            <div className="filter">
                ...
                <div className="filters">
                    ...
                    <div>
                        <input type="checkbox" name="maleCheckbox" id="maleCheckbox" className='checkbox'
                            checked={gender === 'male'}
                            onChange={() => handleGenderChange('male')} />
                        <h4>Male</h4>
                    </div>
                    <div>
                        <input type="checkbox" name="femaleCheckbox" id="femaleCheckbox" className='checkbox'
